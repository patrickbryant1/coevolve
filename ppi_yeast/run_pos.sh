...
posfile=/home/j/juliezhu/pfs/coevolve_yeast/ppi_yeast/ppi_intact_0.75.txt
...
mv ${idx}_jackhmmer.tar.zst $abspath/data_coev/intact/pos/jackhmmer/
cd $tmpdir/combined_data/
tar --use-compress-program /home/p/pbryant/pfs/zstd/programs/zstd -cf ${idx}_final.tar.zst ./*
mv ${idx}_final.tar.zst $abspath/data_coev/intact/pos/combined_data/
